...
import `in`.rithikjain.spillthetea.databinding.FragmentIntroProfileBinding
...
class IntroProfileFragment : Fragment() {
    ...
    private var _binding: FragmentIntroProfileBinding? = null
    private val binding get() = _binding!!

    private val viewModel: IntroProfileViewModel by viewModels()

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        _binding = FragmentIntroProfileBinding.inflate(inflater, container, false)
        return binding.root
    }
